...
<body>
    <div class="header">
        ...
        <p>A new visa application has been created for you.</p>
    </div>
    ...
    <div class="box">
        ...
        @endif
        @if($visaApplication->planned_departure_date)
        <p><strong>Planned departure:</strong> {{ $visaApplication->planned_departure_date->format('M d, Y') }}</p>
        @endif
    </div>
