<x-app-layout>
    ...
    <div class="py-6">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <form action="{{ route('consultancy.inquiries.store') }}" method="POST" class="space-y-6">
                @csrf
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea name="message" rows="4" required
                                class="w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white">{{ old('message') }}</textarea>
                        </div>
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <select name="source" class="w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white">
                                    ...
                                    @foreach(['Website', 'Phone', 'Walk-in', 'Email', 'Social Media', 'Referral'] as $source)
                ...
                <div class="flex justify-end space-x-4">
                    <a href="{{ route('consultancy.inquiries.index') }}" class="px-4 py-2 bg-gray-300 hover:bg-gray-400 text-gray-800 rounded-lg">Cancel</a>
                    <button type="submit" class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg">Create Inquiry</button>
                </div>
            </form>
        </div>
    </div>
