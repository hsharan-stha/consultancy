...
<head>
    ...
    <title>Universities in Japan</title>
    @vite(['resources/css/app.css', 'resources/js/app.js'])
</head>
<body class="bg-gray-100">
    <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
            <h1 class="text-4xl font-bold text-gray-900 mb-4">Universities in Japan</h1>
            <p class="text-xl text-gray-600">Explore top educational institutions for Nepali students</p>
        </div>
                ...
                <div class="p-6">
                    ...
                    <div class="flex items-center justify-between">
                        <span class="text-sm text-gray-500">
                            <strong>{{ $university->number_of_nepali_students }}</strong> Nepali students
                        </span>
