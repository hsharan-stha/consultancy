        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <!-- Recorded paid amounts -->
                    <div class="mb-6">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">{{ __('Paid amounts (recorded)') }}</h3>
                        @if(isset($recordedPayments) && $recordedPayments->count() > 0)
                            <div class="mb-4 p-4 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-800">
                                <p class="text-sm text-green-800 dark:text-green-200">Total paid (recorded): <strong>{{ $recordedPayments->first()->currency ?? 'NPR' }} {{ number_format($totalRecorded ?? 0, 2) }}</strong></p>
                            </div>
                                ...
                                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                    ...
                                    <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-4 py-3 text-sm text-gray-600 dark:text-gray-400">{{ Str::limit($payment->description ?? $payment->notes ?? '—', 30) }}</td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
                        ...
                        @else
                            <p class="text-gray-500 dark:text-gray-400 text-center py-4">{{ __('No recorded payments yet.') }}</p>
                        @endif
                    </div>
